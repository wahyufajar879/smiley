<div id="ticketForm" class="booking_form">
    <form action="<?php echo e(route('ticket.submit')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="form_colum">
                <select class="nc_select" name="destination" id="destination" required>
                    ...
                    <?php $__currentLoopData = $dataTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dataTicket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($dataTicket->destination); ?>"><?php echo e($dataTicket->destination); ?></option>
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '#ticketForm #destination', function() {
            ...
            if (destination) {
                // Ambil data boats
                $.ajax({
                    url: "<?php echo e(route('get.boats')); ?>",
                    type: "GET",
                    data: {
                ...
                // Ambil data times
                $.ajax({
                    url: "<?php echo e(route('get.times')); ?>",
                    type: "GET",
                    data: {
                        destination: destination,
                    },
...
<?php /**PATH D:\Project\Smiley\resources\views/form/ticket.blade.php ENDPATH**/ ?>