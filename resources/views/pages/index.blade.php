                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            {{-- <li class="nav-item">
                                <a class="nav-link" id="place-tab" data-toggle="tab" href="#place" role="tab"
                                    aria-controls="place" aria-selected="false">Place</a>
                            </li> --}}
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="snorkling" role="tabpanel"
                                ...
                                @php
                                   ...
                                   @endphp
                                @include('form.snorkling', ['dataSnorklings' => $dataSnorklings]);
                            </div>
                            <div class="tab-pane fade" id="rent-scooter" role="tabpanel" aria-labelledby="rent-scooter-tab">
                                @include('form.rent_scooter', ['dataRentMotorbikes' => $dataRentMotorbikes])
                            </div>
                            <div class="tab-pane fade" id="ticket" role="tabpanel" aria-labelledby="ticket-tab">
                                @include('form.ticket', ['dataTickets' => $dataTickets])
                            </div>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-lg-6 col-md-6">
                                    <div class="event_slider_content">
                                        ...
                                        <h2>Maldeve - Asia</h2>
                                        <p>Waters make fish every without firmament saw had. Morning air subdue. Our. Air
